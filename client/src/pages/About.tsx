        ...
        <div className="mb-24">
          ...
          {leadPastor ? (
            <div className="bg-white rounded-3xl overflow-hidden shadow-xl border border-gray-100 flex flex-col md:flex-row mb-12">
              <div className="md:w-1/3 h-80 md:h-auto relative bg-gray-200">
                {leadPastor.imageUrl ? (
                  <img 
              ...
              <div className="md:w-2/3 p-8 md:p-12 flex flex-col justify-center">
                ...
                <div className="mt-auto">
                  <span className="inline-block px-4 py-2 bg-gray-100 rounded-full text-sm font-medium text-gray-800">
                    {leadPastor.role}
                  </span>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {departments?.map(dept => (
              <div key={dept.id} className="group bg-white rounded-2xl p-8 shadow-md border border-gray-100 hover:border-primary/20 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600 text-sm mb-6 min-h-[60px]">{dept.description || "Serving God with excellence in this capacity."}</p>
